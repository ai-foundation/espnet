...
from espnet2.train.preprocessor_g2p_fn import CommonPreprocessor
from espnet2.train.preprocessor_g2p_fn import GetPhonemes
...
class TTSTask(AbsTask):
    ...
    @classmethod
    def build_g2p_fn(
        cls, args: argparse.Namespace) -> Optional[Callable[[str, Dict[str, np.array]], Dict[str, np.ndarray]]]:
        assert check_argument_types()
        if args.use_preprocessor:
            retval = GetPhonemes(
                token_type=args.token_type,
